...
namespace Client.Components.Admin_UI.Users.View_Users.TimeTables
{
    public partial class AddLesson : MetroFramework.Controls.MetroUserControl
    {
        public AddLesson()
        {
            InitializeComponent();
        ...
        public AddLesson(int Day, int Period, int TeacherID)
        {
            InitializeComponent();
